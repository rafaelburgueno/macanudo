    ...
    <div class="modal-dialog negro" role="document">
        <div class="modal-content align-items-center">
            ...
            <p class="mx-3">EL club Macanudo te entrega en tu casa todos los meses una variedad de productos, 
                ...
                de edición limitada que solo se elaborara para el club. </p>
            ...
            <form action="{{route('suscribirse')}}" method="POST">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group mb-4">
                        ...
                        <select required class="form-control" id="cantidad_de_quesos" name="cantidad_de_quesos">
                    ...
                    @if( !Auth::check() )
                        ...
                        <div class="form-group mb-4">
                            ...
                            <input type="text" pattern="[A-Za-z0-9 ÁáÉéÍíÓóÚúÜüÑñ]{6,100}" class="form-control" name="nombre" id="nombre" placeholder="Ingrese su nombre" required>
                            @error('nombre')
                                <div class="alert alert-danger mt-1">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="form-group mb-4">
                            ...
                            <input type="password" class="form-control" name="password_confirmacion" id="password_confirmacion" placeholder="..." required>
                    ...
                    <div class="form-group mb-4">
                        ...
                        <input type="date" class="form-control" name="fecha_de_nacimiento" id="fecha_de_nacimiento" title="Número de teléfono inválido" required>
