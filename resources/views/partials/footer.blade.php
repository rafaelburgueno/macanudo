...
<!--  FOOTER --- FOOTER ---- FOOTER ----FOOTER --- FOOTER ---- FOOTER----->
<div class="container">
    <footer class="mt-5" style="color: #ebf0f3; opacity:80% ;">
        <div class="row">
            ...
            <div class="col-sm-4 d-flex flex-column align-items-center">
                ...
                <p><a class="nav-link" href="">Políticas de envío</a></p>
            ...
            <div class="col-sm-4 d-flex flex-column align-items-center">
                ...
                <address class="text-center mb-0">
                    ...
                    <p></p><p><span class="oi oi-envelope-closed footer-address-icon"></span>contacto@macanudo.com</p>
                </address><br><br>
                ...
                <p class="text-center sticky-bottom fixed-bottom d-block">
                    <a class="" href="https://wa.me/59899760201" target="_blank" style="color:#e1e1e1;"> <svg xmlns="http://www.w3.org/2000/svg"
                            width="32" height="32" fill="currentColor" class="bi bi-whatsapp mr-3 "
                            viewBox="0 0 16 16">
                            <path
                    ...
                    <a class="pe-auto" href="https://www.instagram.com/macanudoqueso" target="_blank" style="color:#e1e1e1;"> <svg
                    ...
                    <a class="pe-auto" href="https://www.facebook.com/macanudoqueso" target="_blank" style="color:#e1e1e1;"> <svg
                            xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor"
