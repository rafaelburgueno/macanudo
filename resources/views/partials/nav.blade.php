<nav class="navbar  navbar-expand-lg site-header sticky-top  fixed-top align-items-center"
        ...
        <a class="navbar-brand navbar-logo mr-5" href="{{route('home')}}"><img src="{{asset('/storage/img/maca.1.png')}}" width="159%"></a>
        ...
        <div class="collapse navbar-collapse justify-content-md-center" id="navbarSupportedContent">
            ...
            <ul class="navbar-nav flex-row flex-wrap ms-md-auto">
                <li class="nav-item">
                    <a class="nav-link" href="{{route('mi_carrito')}}" class="ml-3">
                        ...
                        <span class="badge badge-pill badge-danger h6" id="badgeDelCarrito">0</span>
                        <script>
            ...
            @if( Auth::check() )
                <ul class="navbar-nav flex-row flex-wrap ms-md-auto">
                    <li class="nav-item">
                        <a class="nav-link" href="{{route('profile.show')}}" class="ml-5">
            ...
            <ul class="navbar-nav flex-row flex-wrap ms-md-auto">
                <li class="nav-item">
                    <a class="nav-link" href="{{route('login')}}" class="ml-5">Iniciar sesión</a>
                </li>
            </ul>
