...
<div class="container">
    ...
    <div class="row">
        <div class="col  px-5">
            <h1 class="text-center scroll-content fadeLeft" style="color: #e1e1e1;   text-shadow: 1.5px 1.5px  var(--lila);
            ">Todo eso pensamos cuando
                descubrimos nuestras recetas.</h1>
        </div>
